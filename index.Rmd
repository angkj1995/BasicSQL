...
Apart from being applies in the SELECT clause, functions can also be applied in the WHERE/HAVING clause. For instance, we want to filter the community areas from above such that they have an average safety score of at least 80
